...
const Navbar = () => {
  const {
    ...
    isPending,
    error,
  } = useFetch("http://localhost:8000/item");
    ...
    <>
      <div className="bg-slate-50 h-20 w-full flex justify-between px-8">
        ...
        <div className="middle flex space-x-8 ">
          <button>
            <span className="font-bold font-Cereal text-xl">Stays</span>
          </button>
          <button>
            <span className="font-semibold text-lg font-Cereal text-gray-500">
              Experiences
            </span>
          </button>
        </div>
      ...
      <div className="bg-slate-50 h-24 w-auto flex justify-center pb-4 border-b-2 border-gray-200">
        <div className="search-bar-wrapper bg-white self-center justify-around border-black flex w-screen mx-60 h-16 rounded-full shadow-md mt-4 divide-x-2">
          <div className="text-xs self-center pl-5 pr-28 ">
            <span className="font-Cereal">
              Where<br></br>
            </span>
            <span className="font-Cereal font-light text-gray-400">
              Search destinations
            </span>
          </div>
          <div className="text-xs self-center pl-2">
            <span className="font-Cereal">
              Check in <br></br>
            </span>
            <span className="font-Cereal font-light text-gray-400">
